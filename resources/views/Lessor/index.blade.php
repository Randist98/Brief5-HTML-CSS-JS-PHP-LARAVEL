            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-1">
                        <div class="card-body">
                            <h3 class="card-title text-white">Offices</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">{{ $totalOffices }}</h2>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-2">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{ $totalReservations }}</h2>
                                <p class="text-white mb-0">Jan - March 2019</p>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-3">
                        <div class="card-body">
                            <h3 class="card-title text-white">Average Price</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white">$ {{ $averagePrice }}</h2>
                                <p class="text-white mb-0">Jan - March 2019</p>
                            </div>
